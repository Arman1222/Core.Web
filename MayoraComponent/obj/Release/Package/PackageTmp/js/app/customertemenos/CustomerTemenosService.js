(function () {
    window.app.factory('customertemenosService', customertemenosService);

    customertemenosService.$inject = ['$http', 'DataService', 'alerts'];
    function customertemenosService($http, DataService, alerts) {

        var controllerPath = 'CustomerTemenos/'
        var list = [];               
        ...
        function getData(id) {
            for (var i = 0; i < list.length; i++) {
                if (list[i].cifNo == id) return list[i];
            }
