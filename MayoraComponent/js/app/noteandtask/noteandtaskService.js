(function () {
    window.app.factory('noteandtaskService', noteandtaskService);

    noteandtaskService.$inject = ['$http', 'DataService', 'alerts'];
    function noteandtaskService($http, DataService, alerts) {

        var controllerPath = 'MyNoteandTask/'
        var list = [];       
