(function () {
    ...
    window.app.constant('uiCalendarConfig', {
        calendars: {}
    })
    ...
    window.app.directive('ngCalender', ['$timeout', function ($timeout) {
        return {
            scope: {
                ngModel: "="
            },
            ...
            link: function ($scope, $element, attrs) {
                ...
                var configFullcal = {
                    ...
                    drop: function (date, allDay) { // this function is called when something is dropped
                        ...
                        $scope.ngModel.push(copiedEventObject);
                ...
                $element.fullCalendar(configFullcal);
                ...
                //    });
                //}));
                watchers.push($scope.$watch('ngModel', function (value) {
                    $element.data("fullCalendar").update({
                        events: $scope.ngModel
                    });
                }));
