...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(MyWeb.StructureMapConfig), "Configure")]
namespace MyWeb
{
	public static class StructureMapConfig
	{
		public static void Configure()
		{
			IoC.Container.Configure(cfg =>
			{
                ...
                cfg.AddRegistry(new ActionFilterRegistry(namespacePrefix: "MyWeb"));
