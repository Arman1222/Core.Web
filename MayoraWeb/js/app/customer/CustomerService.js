(function () {
    ...
    function customerService($http, DataService, alerts) {
        ...
        var controllerPath2 = 'StoreProcedure/'
        var dbName = 'SQL_USER_ONE';
        var list = [];
        ...
        var svc = {
            ...
            testError: testError,
            ExecStoreProcedure: ExecStoreProcedure,
        };

        return svc;

        function ExecStoreProcedure(params) {
            params.nmModule = dbName
            return DataService.post(controllerPath2 + 'ExecStoreProcedure', params)
