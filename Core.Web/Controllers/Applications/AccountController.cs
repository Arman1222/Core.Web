...
namespace MyWeb.Controllers
{
    ...
    public class AccountController : CoreControllerBase
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            //{
            //    var user = db.Users.FirstOrDefault(u => u.UserName == model.Username); //find by username
            //    if (user != null)
            //    {
        ...
        public ActionResult LogOff()
        {
            ...
            this.saveUserLog(UserId: User.Identity.GetUserId(), TypeLog: "LogOut", Desc: "LogOut", UserName: User.Identity.Name, returnUrl: System.Configuration.ConfigurationManager.AppSettings["ApplicationName"]);
            ...
            //http://dotnetcodr.com/2013/03/18/external-authentication-with-claims-and-ws-federation-in-mvc4-net4-5-part-4-single-signout-and-single-signon/
            //http://stackoverflow.com/questions/9897376/why-does-my-wif-logout-not-log-me-out-of-all-rp-web-sites
