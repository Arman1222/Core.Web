using Core.Web.Registries;
using Heroic.Web.IoC;
using StructureMap.Graph;
using System.Web.Http;
using System.Web.Mvc;

[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(Core.Web.StructureMapConfig), "Configure")]
namespace Core.Web
{
	public static class StructureMapConfig
	{
		public static void Configure()
		{
			IoC.Container.Configure(cfg =>
			{
				...
				cfg.AddRegistry(new ActionFilterRegistry(namespacePrefix: "Core.Web"));
