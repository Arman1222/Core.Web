...
namespace MyWeb.Portal.Controllers
{
    ...
    public class AccountController : CoreControllerBase
    {
        ...
        // GET: /Account/Login
        [AllowAnonymous]
        public ActionResult Login(string message, string returnUrl, bool isSignOut = false)
        {
        ...
        {
            return await LoginAsync(UserManager, SignInManager, model, returnUrl);
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                //uncomment kalau mau force two factor auth setelah register
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //Method LogOff hanya untuk di website portal
        //jika logoff di masing2 aplikasi maka jalankan method LogOff di AccountController yang ada di Core.Web
        ...
        {           
            ...
            //http://sharepointandetc.blogspot.co.id/2014/03/sign-out-from-sts-in-aspnet-web.html
            ...
            //string wreply = fam.Reply; //Request.Url.AbsoluteUri;
            //WSFederationAuthenticationModule.FederatedSignOut(
            //     new Uri(signOutUrl), new Uri(wreply));

            //https://codenamesean.wordpress.com/2012/01/22/single-sign-out-with-w-i-f/

            //return await ProcessWSFederationSignOut(returnUrl);
            ...
            //this.saveUserLog(UserId: , TypeLog: "LogOut", Desc: "LogOut");
            return RedirectToAction("Login", new { returnUrl = returnUrl , isSignOut = true});
        }

        //https://github.com/IdentityServer/IdentityServer2/blob/af35771a07142f9e17764a8c7c39d509c1207b3b/src/Libraries/Thinktecture.IdentityServer.Protocols/WSFederation/WSFederationController.cs
        //private async Task<ActionResult> ProcessWSFederationSignOut(string returnUrl)
        //{            
            
        //    ViewBag.ReturnUrl = !string.IsNullOrEmpty(returnUrl) ? returnUrl : WebHelpers.BaseUrl() ;
        //    ViewBag.SignOut = true;            
        //    TempData["RPList"] = realms;
        //    return RedirectToAction("Login");
        //    //return View("Signout", realms);
        //}

        private List<string> GetRPList()
        {
            List<string> realms = new List<string>();

            using (var ctx = new ApplicationDbContext())
            {
                realms = (from applications in ctx.ApplicationSet
                               where !string.IsNullOrEmpty(applications.ApplicationLink)
                               select applications.ApplicationLink)
                         .ToList();
            }
